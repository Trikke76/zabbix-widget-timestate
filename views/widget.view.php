...
$payload = [
	...
	'fill_opacity' => (int) ($data['fill_opacity'] ?? 100),
	'panel_transparent' => (int) ($data['panel_transparent'] ?? 0),
	...
	'legend_placement' => (int) ($data['legend_placement'] ?? 0),
	'legend_width' => (int) ($data['legend_width'] ?? 260),
