(function() {
	...
	function ensureValueMappingBuilderStyle() {
		...
		style.textContent = [
			...
			'.timestate-dataset-field > span{font-size:12px;color:#d8d8d8;}',
			...
			'.timestate-dataset-add{margin-top:8px;border:1px solid #4a6a8c;background:#2b2b2b;color:#d6e7f6;border-radius:3px;padding:5px 10px;cursor:pointer;}',
			...
			'.timestate-map-add{margin-top:8px;border:1px solid #4a6a8c;background:#2b2b2b;color:#d6e7f6;border-radius:3px;padding:5px 10px;cursor:pointer;}',
