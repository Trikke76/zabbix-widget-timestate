(function() {
	...
	function ensureValueMappingBuilderStyle() {
		...
		style.textContent = [
			...
			'.timestate-dataset-add{margin-top:8px;border:1px solid #8aa2b2;background:#7f97a8;color:#ffffff;border-radius:3px;padding:5px 12px;cursor:pointer;}',
			...
			'.timestate-map-add{margin-top:8px;border:1px solid #8aa2b2;background:#7f97a8;color:#ffffff;border-radius:3px;padding:5px 12px;cursor:pointer;}',
